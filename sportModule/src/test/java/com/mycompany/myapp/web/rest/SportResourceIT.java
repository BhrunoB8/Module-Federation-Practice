...
class SportResourceIT {
    ...
    public static Sport createEntity() {
        return new Sport().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).author(DEFAULT_AUTHOR);
    }
    ...
    public static Sport createUpdatedEntity() {
        return new Sport().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
    }
    ...
    void putExistingSport() throws Exception {
        ...
        updatedSport.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
    ...
    void partialUpdateSportWithPatch() throws Exception {
        ...
        partialUpdatedSport.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateSportWithPatch() throws Exception {
        ...
        partialUpdatedSport.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
